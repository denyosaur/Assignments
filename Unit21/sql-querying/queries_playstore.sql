...
SELECT * FROM analytics WHERE price < 1 AND price > .10 ORDER BY DESC LIMIT 10;
...
SELECT *, min_installs/reviews AS "install/review" FROM analytics WHERE min_installs > 100000;